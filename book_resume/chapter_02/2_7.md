...
<table border="1">
  ...
  <thead>
    ...
    <tr>
      <th style="background-color: darkgrey; color: white;" rowspan="2">Name of the cipher, MAC<br>or AEAD combination</th> <!-- This header spans 2 rows -->
      <th style="background-color: darkgrey; color: white;" colspan="2">Cipher specs</th> <!-- This header spans 2 columns -->
      <th style="background-color: darkgrey; color: white;" colspan="3">Other specs, notes</th> <!-- This header spans 2 columns -->
      <th style="background-color: darkgrey; color: white;" rowspan="2">Cipher<br>details</th> <!-- This header spans 2 rows -->
    </tr>
    <!-- Second row with sub-headers -->
    <tr>
      <th style="background-color: darkgrey; color: white;">n (bits)</th>
      <th style="background-color: darkgrey; color: white;">y (bits)</th>
      <th style="background-color: darkgrey; color: white;">mode</th>
      <th style="background-color: darkgrey; color: white;">v</th>
      <th style="background-color: darkgrey; color: white;">t</th>
    </tr>
  </thead>
  <!-- Table Body -->
  <tbody>
